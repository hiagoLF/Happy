...
import mapMarkerImg from '../images/happy_icon/map-marker.png';
...
interface Orphanage {
  ...
  //Arrays de objetos podem ser declarados dessa maneira no TypeScript
  images: Array<{
    id: string,
    url: string
  }>
...
export default function OrphanageDetails() {
  ...
  function handleGoogleMapsRoutes(){
    //orphanage?.latitude --> Com ? o TypeScript verifica se orphanage existe e isso resolve o erro. 
